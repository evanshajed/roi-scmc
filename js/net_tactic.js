...
CNT_BW_Display=0.60; CNT_BW_Geofencing=0.05; CNT_BW_Video=0.20; CNT_BW_Video_Geofencing=0.05;   CNT_BW_OTT_CTV=0.10;
...
///////////////////////////////////////////////////////////////////////////////////
                ...
                function tactic_net_MCMC_row_1(){
                    ...
                    var S_CNT_BW_Geofencing    = CNT_BW_Geofencing.toString().replace(regex,'');
                    var S_CNT_BW_Display        = CNT_BW_Display.toString().replace(regex,'');
                    var S_CNT_RR_Display        = CNT_RR_Display.toString().replace(regex,'');
                    var S_CNT_M_Display         = CNT_M_Display.toString().replace(regex,'');
                    var S_CNT_BW_OTT_CTV        = CNT_BW_OTT_CTV.toString().replace(regex,'');
                    ...
                    var S_CNT_BW_Video          = CNT_BW_Video.toString().replace(regex,'');
                    var S_CNT_RR_Video          = CNT_RR_Video.toString().replace(regex,'');
                    var S_CNT_M_Video            = CNT_M_Video.toString().replace(regex,'');
                    var S_CNT_BW_Video_Geofencing = CNT_BW_Video_Geofencing.toString().replace(regex,'');
                ...
                function tactic_net_SNR_row_1(){
                    ...
                    CNT_Block_SNR_1  = S_CNT_Block_MCMC_1 - S_CNT_Block_SC_1
                ...
                function tactic_net_SNR_row_2(){
                    ...
                    CNT_Block_SNR_2  = S_CN_Block_MCMC_2 - S_CN_Block_SC_2
                ...
                function tactic_net_SNR_row_3(){
                    ...
                    CNT_Block_SNR_3  = CNT_Block_MCMC_3 - CNT_Block_SC_3
